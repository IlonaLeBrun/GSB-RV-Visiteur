package fr.gsb.gsbvisiteur.modele;
...
import fr.gsb.gsbvisiteur.entites.Medicament;
import fr.gsb.gsbvisiteur.entites.Motif;
import fr.gsb.gsbvisiteur.entites.Praticien;
...
public class ModeleGsb {
    ...
    private void peupler() {
        ...
        this.lesRapportsVisites.add(new RapportVisite(1, "RAS", 2, new GregorianCalendar(2018, Calendar.MARCH, 3), new GregorianCalendar(2018, Calendar.MARCH, 5), true));
        ...
        this.lesRapportsVisites.add(new RapportVisite(2, "RAS", 4, new GregorianCalendar(2018, Calendar.JANUARY, 5), new GregorianCalendar(2018, Calendar.JANUARY, 8), false));
        ...
        this.lesRapportsVisites.add(new RapportVisite(3, "RAS", 4, new GregorianCalendar(2018, Calendar.JUNE, 14), new GregorianCalendar(2018, Calendar.JUNE, 16), true));
        ...
        this.lesRapportsVisites.get(2).setLePraticien(this.lesPraticiens.get(4));
        this.lesRapportsVisites.get(2).getLesEchantillons().put(this.lesMedicaments.get(1), new Integer(2));
        this.lesRapportsVisites.get(2).getLesEchantillons().put(this.lesMedicaments.get(4), new Integer(2));
        this.lesRapportsVisites.get(2).getLesEchantillons().put(this.lesMedicaments.get(5), new Integer(2));

        this.lesRapportsVisites.add(new RapportVisite(4, "RAS", 4, new GregorianCalendar(2018, Calendar.AUGUST, 25), new GregorianCalendar(2018, Calendar.AUGUST, 30), true));
        ...
        this.lesRapportsVisites.get(3).setLePraticien(this.lesPraticiens.get(6));
        this.lesRapportsVisites.get(3).getLesEchantillons().put(this.lesMedicaments.get(1), new Integer(1));
        this.lesRapportsVisites.get(3).getLesEchantillons().put(this.lesMedicaments.get(4), new Integer(2));
